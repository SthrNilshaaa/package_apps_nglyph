...
public class GlyphManagerV2 {
    ...
    public void init(Context context) {
        ...
        if (pm != null) {
            wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "GlyphManager:HardwareExecutor");
        }
    }
    ...
    /**
     * Updates multiple glyphs in a single call.
     * Uses fastWriteBatch for rootless/root hybrid execution.
     */
    public void setGlyphBrightness(java.util.Map<Glyph, Integer> updates) {
        ...
        ShellUtils.fastWriteBatch(pathUpdates);
    ...
    private void writeSysfs(final String path, final String value) {
        ...
        ShellUtils.fastWrite(path, value);
